...
waitForElement([".Root__nav-bar, #Desktop_LeftSidebar_Id"], ([resizer]) => {
  function updateVariable() {
    ...
    const value =
      Number(computedStyle.getPropertyValue("--left-sidebar-width").trim()) ||
      resizer.clientWidth;
...
// Auto-detect macOS light/dark mode
const mediaQuery = window.matchMedia("(prefers-color-scheme: dark)");
function updateTheme() {
  if (mediaQuery.matches) {
    Spicetify.Prefs.theme = "Glass";
  } else {
    Spicetify.Prefs.theme = "Glass-light";
  }
  Spicetify.updateTheme();
}
